...
from MSE_tools_SGD import get_MSE_value_for_certain_features
...
def main():
    ...
    X_train_for_FS, X_validation_for_FS, y_train_for_FS, y_validation_for_FS = train_test_split(X_train, y_train, test_size=0.2, random_state=123)
    ...
    file_name = 'Result_for_FS_SGD.xlsx'  # 设置输出的 Excel 文件名
