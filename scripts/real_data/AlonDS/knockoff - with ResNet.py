...
from MSE_tools_with_ResNet50 import get_MSE_list_for_BestKFeatures, get_MSE_value_for_certain_features
...
def save_everything_about_BestKFeatures(list_of_bestK_indices_lists, MSE_list):
    ...
    output_file = 'Result_for_Original_Knockoff - ResNet edition.xlsx'  # 设置输出的 Excel 文件名
