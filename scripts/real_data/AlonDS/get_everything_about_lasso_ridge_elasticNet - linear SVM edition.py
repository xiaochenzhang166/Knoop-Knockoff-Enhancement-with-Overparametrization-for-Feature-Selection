...
import pandas as pd
from MSE_tools_with_linear_SVM import load_datasets_for_GeneralizedLinearRegression, get_MSE_list_for_BestKFeatures
...
def save_everything_for_GLMs(Lars_MSE, Ridge_MSE, Lasso_MSE, ElasticNet_MSE):
    ...
    file_name = 'Result_for_GLMs - SVM edition.xlsx'  # 设置输出的 Excel 文件名
