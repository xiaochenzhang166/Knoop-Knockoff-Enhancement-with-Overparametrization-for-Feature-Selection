...
from MSE_tools_SGD import load_datasets_for_GeneralizedLinearRegression
from get_everything_about_BestKFeatures import get_indices_from_the_best_feature_alone_to_all_features, get_MSE_list_for_BestKFeatures
...
def get_datasets_for_knockoffBO_CV():
    ...
    X_train_part_1 = all_X_train[0:7, :]
    y_train_part_1 = all_y_train[0:7]
    X_train_part_2 = all_X_train[7:14, :]
    y_train_part_2 = all_y_train[7:14]
    X_train_part_3 = all_X_train[14:21, :]
    y_train_part_3 = all_y_train[14:21]
    X_train_part_4 = all_X_train[21:28, :]
    y_train_part_4 = all_y_train[21:28]
    X_train_part_5 = all_X_train[28:, ]
    y_train_part_5 = all_y_train[28:, ]
...
def save_bestK_list(bestK_list, mse_list):
    ...
    output_file = 'Result_for_CV_KnockoffBO_SGD.xlsx'  # 设置输出的 Excel 文件名
