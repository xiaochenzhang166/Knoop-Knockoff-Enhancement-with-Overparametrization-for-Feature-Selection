import numpy as np
from Three_layer_NN import get_errorRate_from_three_layer_NN
...
def get_MSE_value_for_certain_features(indexArray):
    ...
    errorRate = get_errorRate_from_three_layer_NN(X_train_extracted, y_train, X_test_extracted, y_test)
