...
def get_errorRate_from_TWO_layer_NN(X_train, y_train, X_test, y_test):
    ...
    class TwoLayerNN(nn.Module):
        ...
        def forward(self, x):
            ...
            x = torch.sigmoid(self.layer2(x))  # 修改这里，添加sigmoid激活函数
            return x
    ...
    model = TwoLayerNN(input_size, hidden_size1, num_classes)  # 输出大小改为类别数量
    ...
    # 计算准确率
    accuracy = accuracy_score(y_test.astype(np.int64), y_pred.numpy())
