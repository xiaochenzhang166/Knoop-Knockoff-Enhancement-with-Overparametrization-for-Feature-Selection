...
import pandas as pd
from MSE_tools import load_datasets_for_GeneralizedLinearRegression, get_MSE_list_for_BestKFeatures
...
def get_Absolute_coefficient_for_Lars(Xtrain, ytrain):
    ...
    lars_model = linear_model.Lars(n_nonzero_coefs=50)
...
def save_everything_for_GLMs(Lars_MSE, Ridge_MSE, Lasso_MSE, ElasticNet_MSE):
    ...
    file_name = 'Result_for_GLMs.xlsx'  # 设置输出的 Excel 文件名
