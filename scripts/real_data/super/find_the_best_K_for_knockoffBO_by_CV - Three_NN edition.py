...
from get_everything_about_BestKFeatures_Three_NN_edition import get_indices_from_the_best_feature_alone_to_all_features, get_MSE_list_for_BestKFeatures
...
def get_datasets_for_knockoffBO_CV():
    ...
    X_train_part_1 = all_X_train[0:72, :]
    y_train_part_1 = all_y_train[0:72]
    X_train_part_2 = all_X_train[72:144, :]
    y_train_part_2 = all_y_train[72:144]
    X_train_part_3 = all_X_train[144:216, :]
    y_train_part_3 = all_y_train[144:216]
    X_train_part_4 = all_X_train[216:288, :]
    y_train_part_4 = all_y_train[216:288]
    X_train_part_5 = all_X_train[288:, ]
    y_train_part_5 = all_y_train[288:, ]
...
def save_bestK_list(bestK_list, mse_list):
    ...
    output_file = 'Result_for_CV_KnockoffBO - Three_NN.xlsx'  # 设置输出的 Excel 文件名
