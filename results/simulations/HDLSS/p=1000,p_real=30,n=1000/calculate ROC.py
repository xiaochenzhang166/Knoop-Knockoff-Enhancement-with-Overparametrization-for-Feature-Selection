...
# calculate metric for Linear Regression p-value ----------------------
linear_regression_fpr = calculate_fpr(p_scores_for_regression, label)
linear_regression_tpr = calculate_tpr(p_scores_for_regression, label)
roc_auc_for_linear_regression = metrics.auc(linear_regression_fpr, linear_regression_tpr)
